<x-app-dashboard-layout>
    ...
    <div class="min-h-[calc(100vh-8rem)] content-center place-self-center">
        ...
        <h2 class="text-4xl font-bold dark:text-white mb-16">Ajouter un <span class="text-green-700 dark:text-green-600">médicament</span> au stock</h2>
        ...
        <div class="mb-16  md:w-96">
            ...
            <input placeholder="100100100100" type="text" id="default-input" class="px-4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500">
