<x-app-customer-layout>
    ...
    <section class="min-h-[calc(100vh-4rem)] antialiased flex flex-col md:flex-row items-center justify-center py-16 px-4 lg:px-12 xl:px-24 md:py-32 bg-white dark:bg-gray-900 md:gap-6 transition-all duration-300">
        ...
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Panier</h2>
            ...
            <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        @if ($requiresPrescription)
                            <div class="flex justify-between items-center rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                                ...
                                <input type="file" name="prescription" class="ml-6 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 p-2">
                            </div>
                        @endif
                                ...
                                <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                    ...
                                    <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                        <p class="text-base font-medium text-gray-900 dark:text-white">
                                            ...
                                            Catégorie : <span class="font-light">{{ $item->medicine->category ?? 'Inconnue' }}</span>
                                        </p>
                ...
                <div class="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
                    <div class="min-w-64 space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                        ...
                        <a href="#" class="flex w-full items-center justify-center rounded-lg bg-green-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Confirmer la commande</a>
