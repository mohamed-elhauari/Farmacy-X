<x-app-customer-layout>
    ...
    <div class="place-items-center px-6 xl:px-24 py-10 sm:py-14 bg-white md:py-24 dark:bg-gray-800">
        ...
        <!-- Medicines grid -->
        <div class="grid grid-cols-1 sm:place-items-start sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
            ...
            <button type="button" class="sm:col-span-2 md:col-span-3 lg:col-span-4 xl:col-span-5 w-full mt-4 py-2.5 px-6 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:border-green-200 hover:text-green-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-green-600 hover:dark:border-green-800">Voir tous les médicaments</button>
